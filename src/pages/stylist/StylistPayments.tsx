...
import { ArrowLeft, CreditCard, ExternalLink, Check, AlertCircle, DollarSign, TrendingUp } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-secondary/30 to-accent/10 p-4">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <Button variant="outline" onClick={() => navigate("/stylist/appointments")} className="w-full">
