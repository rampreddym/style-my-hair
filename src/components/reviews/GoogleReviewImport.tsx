...
export const GoogleReviewImport = ({
  ...
  const handleSearch = async () => {
    if (!searchQuery.trim()) {
      toast({
        ...
        description: "Please enter your business name or address to search",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      if (data?.results && data.results.length > 0) {
        ...
        toast({
          ...
          description: "Try searching with a different business name or address",
        });
      }
    } catch (error: any) {
  ...
  const handleConnect = async (place: GooglePlace) => {
    ...
    try {
      // Update stylist with Google Place ID
      ...
      toast({
        ...
        description: `Imported ${importResult?.reviewsImported || 0} reviews from Google`,
      });
      setSearchResults([]);
      setSearchQuery("");
    } catch (error: any) {
          ...
          <div className="flex items-center gap-3 p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground">
                Reviews are synced from your Google Business profile
              </p>
            </div>
            <Button
              variant="outline"
